    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/hmlogo.png" alt="" width="60px" height="45px"> </a>
    ...
    <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Food Zone <br> Delivery | Take-Out  </h1>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Dishes | Food Zone</h2>
    ...
    <section class="featured-restaurants">
        <div class="container">
            <div class="row">                  
                <div class="col-sm-4">
                    <div class="title-block pull-left">
                        <h4>Featured Map - Ampara District</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1013507.6860927589!2d80.76976525413667!3d7.1243277355819705!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae53ee278bb7165%3A0xb62809869d561da1!2sAmpara!5e0!3m2!1sen!2slk!4v1700464583412!5m2!1sen!2slk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>        
            </div>
        </div>
    </section>
